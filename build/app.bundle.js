...
var _TodoList = __webpack_require__(40);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_TodoList2.default, { items: this.state.data, remove: this.removeTodo.bind(this) })
            );
        }
    }]);
...
var TodoList = function TodoList(props) {
    var todoItem = props.items.map(function (item) {
        return _react2.default.createElement(
            "li",
